...
<head lang="en">
    ...
    <title><?=$title_page_current;?></title>
...
<link href="<?=base_url();?>assets/common/css/jquery-ui.min.css" rel="stylesheet"> 

<!--Data Picker -->
<link href="<?=base_url();?>assets/common/css/datepicker.css" rel="stylesheet"> 
<link href="<?=base_url();?>assets/common/js/bootstrap-datepicker.js" rel="stylesheet">
...
<script src="<?=base_url();  ?>assets/vendors/jquery/French.json"></script>
