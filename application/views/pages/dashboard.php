...
<div class="page-content-inner">
 ...
 <div class="col-xl-6">
                ...
                <div class="col-lg-6">
                    <h4>CSS Styling & Animations</h4>
                    <p>Modifier: see documentation</p>
                    <br />
...
var data = {
  ...
  labels: ['lundi', 'Tue', 'Wed', 'Thu', 'Fri','Fri'],
...
new Chartist.Line('.ct-chart', data);
        ...
        new Chartist.Line(".chart-line", {
            labels: ["lundi", "Tuesday", "Wednesday", "Thursday", "Friday"],
            series: [
                [12, 13, , 8, 5],
                [2, 1, 3.5, 7, 3],
                [1, 3, 4, 5, 6]
...
//////
      var overlappingData = {
        ...
        new Chartist.Bar(".chart-salah", overlappingData, overlappingOptions, overlappingResponsiveOptions);
