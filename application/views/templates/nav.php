...
assets/common/img/logo.png" alt="Clean UI Admin Template" />
            <img class="logo-inverse" src="<?php echo base_url();  ?>
assets/common/img/logo-inverse.png" alt="Clean UI Admin Template" />
        </a>
    </div>
        ...
        <ul class="left-menu-list left-menu-list-root list-unstyled">
            ...
            <li class="left-menu-list-active">
                <a class="left-menu-link" href="index.html">
                    ...
                    <span class="menu-top-hidden">Accueil</span> 
                </a>
            </li>
