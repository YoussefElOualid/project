...
assets/home/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
assets/home/css/line-icons.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
assets/home/css/owl.carousel.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
assets/home/css/owl.theme.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
assets/home/css/nivo-lightbox.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
assets/home/css/magnific-popup.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
assets/home/css/animate.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
assets/home/css/menu_sideslide.css">
    <link rel="stylesheet" href="<?=base_url();  ?>
        ...
        <nav class="menu navbar">
          <div class="icon-list navbar-collapse">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url() . 'login/index'  ?>">ExtraNet</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#portfolios">Partenaires</a>
              </li>            
              <li class="nav-item">
...
assets/home/video/video3"></div>
      <div class="fixed-top">
          <div class="container">
            <div class="logo-menu">
              <a href="<?= base_url(); ?>" class="logo"><span class="lnr lnr-diamond"></span>  FincaCards</a>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              ...
              <a href="<?= base_url() . 'login/index'  ?>"    class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms"><i class="lnr lnr-download"></i> ExtraNet </a>
            </div>
          </div>
        </div> 
      </div>      
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="show-box wow fadeInDown animated" data-wow-offset="10">
              <img style="margin-top : -100px"  src="<?=base_url();  ?>
assets/home/img/features/image002.png" alt="">
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
assets/home/img/portfolio/img1.jpg">
                      <img src="<?=base_url();  ?>
assets/home/img/portfolio/img1.jpg" alt="" />  
...
assets/home/img/portfolio/img1.jpg" alt="" />  
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix planning">
                <div class="portfolio-item">
                  <div class="shot-item">
                    <a class="overlay lightbox" href="<?=base_url();  ?>
assets/home/img/portfolio/img2.jpg">
                      <img src="<?=base_url();  ?>
assets/home/img/portfolio/img2.jpg" alt="" />  
                      <i class="lnr lnr-plus-circle item-icon"></i>
                    </a>
                  </div>               
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix research">
                <div class="portfolio-item">
                  <div class="shot-item">
                    <a class="overlay lightbox" href="<?=base_url();  ?>
assets/home/img/portfolio/img3.jpg">
                      <img src="<?=base_url();  ?>
assets/home/img/portfolio/img3.jpg" alt="" />  
                      <i class="lnr lnr-plus-circle item-icon"></i>
                    </a>
                  </div>               
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix marketing research">
                <div class="portfolio-item">
                  <div class="shot-item">
                    <a class="overlay lightbox" href="<?=base_url();  ?>
assets/home/img/portfolio/img4.jpg">
                      <img src="<?=base_url();  ?>
assets/home/img/portfolio/img4.jpg" alt="" />  
                      <i class="lnr lnr-plus-circle item-icon"></i>
                    </a>
                  </div>               
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix marketing planning">
                <div class="portfolio-item">
                  <div class="shot-item">
                    <a class="overlay lightbox" href="<?=base_url();  ?>
assets/home/img/portfolio/img5.jpg">
                      <img src="<?=base_url();  ?>
assets/home/img/portfolio/img5.jpg" alt="" />  
                      <i class="lnr lnr-plus-circle item-icon"></i>
                    </a>
                  </div>               
                </div>
                ...
                <div class="portfolio-item">
                  <div class="shot-item">
                    <a class="overlay lightbox" href="img/portfolio/img6.jpg">
                      <img src="<?=base_url();  ?>
assets/home/img/portfolio/img6.jpg" alt="" />  
                      <i class="lnr lnr-plus-circle item-icon"></i>
                    </a>
                  </div>               
                </div>
          ...
          <div class="col-md-10 wow fadeInRight" data-wow-delay="0.2s">
            <div class="touch-slider owl-carousel owl-theme">
              <div class="testimonial-item">
                <img src="<?=base_url();  ?>
assets/home/img/testimonial/customer1.png" alt="Client Testimonoal" />
              ...
              <div class="testimonial-item">
                <img src="<?=base_url();  ?>
assets/home/img/testimonial/customer2.png" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Morbi eget dictum enim. Praesent sed quam sit amet lorem tempor rhoncus. <br>In hac habitasse platea dictumst. Vivamus in accumsan ex</p>
                  <h3>Oidila Matik</h3>
              ...
              <div class="testimonial-item">
                <img src="<?=base_url();  ?>
assets/home/img/testimonial/customer3.png" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Morbi eget dictum enim. Praesent sed quam sit amet lorem tempor rhoncus. <br>In hac habitasse platea dictumst. Vivamus in accumsan ex</p>
                  <h3>- Alex Dattilo</h3>
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.3s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?=base_url();  ?>
assets/home/img/blog/img1.jpg" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.6s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?=base_url();  ?>
assets/home/img/blog/img2.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <h3>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.9s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?=base_url();  ?>
assets/home/img/blog/img3.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text">    
                <h3>
        ...
        <div class="row justify-content-md-center">          
          <div class="col-md-9 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">            
            <div class="contact-block"> 
              ...
              <div class="section-header">          
                <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Contactez  <span>Nous</span></h2>
                <hr class="lines wow zoomIn" data-wow-delay="0.3s">
              </div>
              <form id="contactForm">
                <div class="row">
...
Votre Email" id="email" class="form-control" name="name" required data-error="S'il vous Entrez votre email">
                      <div class="help-block with-errors"></div>
                    </div> 
                  </div>
                   <div class="col-md-12">
                    <div class="form-group">
                      <input type="text" placeholder="Subject" id="msg_subject" class="form-control" required data-error="S'il vous 
Entrez votre sujet">
                      <div class="help-block with-errors"></div>
                    </div>
                  </div>
...
Votre message" rows="11" data-error="Écrivez votre message
" required></textarea>
                      <div class="help-block with-errors"></div>
                    </div>
...
Envoyer le message</button>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="site-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s">
              <p>All copyrights reserved &copy; 2017 - Designed & Developed by <a rel="nofollow" href="#">FinaCards</a></p>
            </div>  
          </div>
        </div>
      </div>
    ...
    <script src="<?=base_url();  ?>
assets/home/js/jquery-min.js"></script>

    <script src="<?=base_url();  ?>
assets/home/js/tether.min.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/bootstrap.min.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/classie.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/mixitup.min.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/nivo-lightbox.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/owl.carousel.min.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/jquery.stellar.min.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/jquery.nav.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/smooth-scroll.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/smooth-on-scroll.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/wow.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/menu.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/jquery.vide.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/jquery.counterup.min.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/jquery.magnific-popup.min.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/waypoints.min.js"></script>    
    <script src="<?=base_url();  ?>
assets/home/js/form-validator.min.js"></script>
    <script src="<?=base_url();  ?>
assets/home/js/contact-form-script.js"></script>     
    <script src="<?=base_url();  ?>
assets/home/js/main.js"></script>
