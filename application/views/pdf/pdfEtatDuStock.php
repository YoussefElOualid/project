...
// $query="select b.card_type, c.label, c.stock+count(1) as stock_int, count(1) as consomme, c.stock as stock_act, SUM(IF(b.line_status>100,1,0)) as reject, c.tested from llx_command_files a, llx_command_filedet b, llx_extranet_product c where a.rowid = b.fk_object and b.card_type = c.card_type and b.bank_code = c.bank_code and file_reception_start between '2017/05/01' and '2017/05/31' group by a.clt_reference, c.label limit 150";
