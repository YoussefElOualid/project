...
SUM(IF(a.clt_reference="E2909200",1,0)) as "200",
SUM(IF(a.clt_reference="E2909310",1,0)) as "310",
SUM(IF(a.clt_reference="E2910254",1,0)) as "254",
...
limit 150';
    	...
    	$con = new mysqli('localhost','root','root','lastdb');
    	$res = $con->query($query);
...
.info{
		position: absolute;top: -1%;right: 5%;width: 50%
}
.info *{
...
<thead>
<tr>
	<th align="center" rowspan="2">Type de Carte</th>
