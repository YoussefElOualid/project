...
//$query="select llx_product.label ,llx_command_files.total_card  ,'testtype' as type from llx_product inner join llx_command_files on llx_product.rowid = llx_command_files.rowid";
 ...
 // $query="SELECT a.card_number,a.card_type, a.branch_code, a.line_comment FROM `llx_command_filedet` a, `llx_command_files` b WHERE a.`fk_object` = b.rowid ".isuserBank('a')." limit 30";
...
<h1> Tableau de Controle de Fabrication(Rejets)</h1> 
<table>
 <tr>
